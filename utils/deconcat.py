...
def deconcat_img(out_dir, concat_gen_img, indices, concat_img_coords_list, human_dims_list, indices_to_gen_save_flag = None):
    ...
    for i, save, concat_img_coords, human_dims in zip(indices, indices_to_gen_save_flag, concat_img_coords_list, human_dims_list):
        ...
        if save:
            ...
            img.save(os.path.join(img_dir, f'train_{i:04d}.png'))
